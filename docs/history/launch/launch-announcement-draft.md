# Agent Gate v0.2.1 Launch Draft

## Title

Agent Gate v0.2.1: No AI PR gets merged without proof.
...
`v0.2.1` is a GitHub prerelease and GitHub Marketplace Action. The core
...
This release adds evidence snapshots to JSON and Markdown reports so each
finding carries the canonical material used to derive its stable finding ID.
...
- `v0.2.1` is pre-release; APIs, rule names, reports, and configuration may
  change.
