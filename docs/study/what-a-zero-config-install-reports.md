...
worked since [v0.5.0](../history/releases/release-notes-v0.5.0.md).
...
in [v0.7.0](../history/releases/release-notes-v0.7.0.md), each verified by reading a pull request
...
[v0.6.0](../history/releases/release-notes-v0.6.0.md) for why. Two also produced
...
> [v0.9.0](../history/releases/release-notes-v0.9.0.md), which is a direct consequence of this
